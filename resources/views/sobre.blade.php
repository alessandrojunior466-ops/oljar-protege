...
<body>
    <div class="container">
        <header>
            <div class="cabecalho">
                <img src="{{ asset('img/olhar_que_protege_transparente.svg') }}" width="200" height="auto"
                    alt="Logo Olhar Que Protege" />

                <nav>
                    <h2><a href="{{ route('home') }}">Inicio</a></h2>
                    <h2><a href="{{ route('sobre') }}">Sobre</a></h2>
                    <h2><a href="{{ route('videos') }}">Videos</a></h2>
                    <h2><a href="{{ route('contato') }}">Contato</a></h2>
        ...
        <main>
            ...
            <div class="logo">
                <img src="{{ asset('img/olhar_que_protege_transparente.svg') }}" alt="" width="400"
                    height="auto" />
            </div>

            <div class="subtitu"></div>
            <br /><br />
            ...
            <div class="conteudo-info">
                ...
                <div>
                    <img class="meninaChora" src="{{ asset('img/tiazinha.jpg') }}" alt="" />
                </div>
                ...
                <div class="textoInfo">
                    ...
                    <p>
                        ...
                        un portal vasto de conhecimento e conexão. Contudo, para crianças e
                ...
                <img class="FaCircle" src="{{ asset('img/familycircle.png') }}" alt="" />
            ...
            <div class="SobreNos">
                ...
                <br>
                <p>Temos o prazer de apresentar o "Olhar Que Protege", um projeto desenvolvido com paixão e expertise
                    ...
                    meninas. Em um mundo onde a violência e o risco, especialmente o abuso e a exploração, se manifestam
                    ...
                    crucialmente, a fortalecer o diálogo em casa, promovendo um ambiente seguro e de confiança. O
                    projeto é a prova de que a Tecnologia da Informação não é apenas sobre códigos e sistemas, mas sobre
    ...
    <div class="mane">
        <div class="imagemzinha">
            <img src="{{ asset('img/Capturar.PNG') }}" alt="Captura de tela do projeto" />
        </div>
    </div>
