...
<body>
    <div class="container">
        ...
        <main class="container-blog">
            ...
            @if ($destaque)
                <!-- Post em Destaque Clicável -->
                <a href="{{ route('blog.show', $destaque->id) }}" class="post-link">
            ...
            <div class="grade-posts">
                @forelse($posts->skip(1) as $post)
                    <!-- Card de Post Individual Clicável -->
                    <a href="{{ route('blog.show', $post->id) }}" class="post-link">
