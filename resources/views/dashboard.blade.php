    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-footer">
                <div class="user-info">
                    <p class="user-name">{{ Auth::user()->nome ?? Auth::user()->name ?? 'Usuário' }}</p>
        ...
        <main class="main-content">
            ...
            <section class="content-body">
                ...
                <div class="dashboard-grid">
                    ...
                    <!-- FORMULÁRIO DE NOVA PUBLICAÇÃO / EDIÇÃO -->
                        ...
                        <form action="{{ route('blog') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="titulo" id="titulo"
                                    value="{{ isset($postEdicao) && $postEdicao ? $postEdicao->titulo : '' }}" required
                            ...
                            <div class="form-group">
                                ...
                                @if (isset($postEdicao) && $postEdicao && !empty($postEdicao->imagem))
                                    <div style="margin-top: 10px;">
                                        <small>Imagem atual:</small><br>
                                        <img src="{{ asset($postEdicao->imagem) }}" width="100" style="border-radius: 4px; margin-top: 5px;">
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="conteudo" id="conteudo" rows="6" required
                                    placeholder="Digite o conteúdo completo da sua publicação aqui...">{{ isset($postEdicao) && $postEdicao ? $postEdicao->conteudo : '' }}</textarea>
                            </div>
                                ...
                                <div class="post-item">
                                    <div style="display: flex; gap: 15px; align-items: start;">
                                        ...
                                        <div style="flex-grow: 1;">
                                            <span class="post-date">Criado em: {{ $post->created_at ? $post->created_at->format('d/m/Y H:i') : '-' }}</span>
                                            <h3>{{ $post->titulo }}</h3>
                                    ...
                                    <!-- Botões de Ação -->
                                    <div class="post-actions" style="display: flex; gap: 10px; margin-top: 15px; justify-content: flex-end;">
                                        <a href="{{ route('dashboard', $post->id) }}" class="btn-action-edit">Editar</a>
